...
while True:
    ...
    while True:
        ...
        if (input_one-1) != computer_selected_index and symbols[computer_selected_index] != "🚗":
            break
    ...
    if input_one == input_two and symbols[input_two-1] == "🚗":
        notchanged.append("WIN")
    elif input_one == input_two and symbols[input_two-1] == "🐐":
